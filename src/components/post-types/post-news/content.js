...
export default function Content({ object }) {
  ...
  return (
    <div className="font-fontbasic text-primary  flex flex-col w-full px-4">
      <h2 className="font-semibold text-xl mt-4">{object.newsTitle}</h2>
      ...
      <p className="text-sm font-regular mt-4 break-all">{object.text}</p>
      ...
      <div className="flex justify-between items-center w-full">
        <div className="flex text-sm">
          <p className="mr-4">From the source: </p>
