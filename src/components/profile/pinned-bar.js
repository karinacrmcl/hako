...
export default function Pinned({ pinnedPublications, setIsOpen, isOpen }) {
  ...
  return (
    <div className="bg-white flex items-center px-2.5 shadow-xl w-full h-12 rounded-lg mt-10 ml-20 relative">
      ...
      {isOpen ? (
        ...
        >
          <p
            className={`text-gray-extralight font-medium text-sm transition-all duration-300  ${
