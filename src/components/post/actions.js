      ...
      <div className="flex w-full justify-between py-3 px-4 h-14 rounded-b-lg select-none">
        <div className="flex select-none">
          <svg
            ...
            className={`w-8 mr-4 select-none cursor-pointer focus:outline-none lptpXS:w-6 ${
              toggleLiked
          ...
          {showComments === true ? (
            <svg
              ...
              className="cursor-pointer -mt-1 lptpXS:w-7"
            >
              <path
        ...
        <div>
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className={`w-8 select-none cursor-pointer focus:outline-none lptpXS:w-5 ${
              togglePinned
                ? "fill-active actions-active"
                : "text-black-light actions-inactive"
            } `}
          ...
          >
            ...
            <path
              ...
              stroke="#E1E1E1"
              strokeWidth={`${togglePinned ? "0" : "1.5"}`}
            />
          </svg>
        </div>
      </div>
